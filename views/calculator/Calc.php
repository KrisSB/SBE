...
<head>
	...
	?>
	<title>Shadowbane Calculator</title>
	<meta name="description" content="The Shadowbane Calculator, Character Creation, Skills & Powers, Gear, Character Information and Resists all in an easy to use format">
	<meta name="keywords" content="video, games, video games, strategy, calculator, shadowbane, shadowbane emulator, emulator">
	<style type="text/css">
            ...
            * {
            ...
            body {
                font-family: verdana;
                background-image: url('images/calcnav2.jpg');
            }
            #container {
                width: 75%;
                min-height: 600px;
            ...
            #CalcNav {
                background-image: url('images/calcnav.jpg');
                color: #FFF;
            }
            #CalcNav li {
                list-style: none;
            ...
            #bscStats input[type=text] {
                width: 30px;
                height: 30px;
                font-size: 20px;
		text-align: center;
            }
            #bscStats input[type=button] {
                width: 40px;
                height: 30px;
                font-size: 15px;
                text-align: center;
            ...
            #bscStats input[type=button]:hover {
                background-image: url('images/buttonh.jpg');
            }
            #bscRunes {
                display: none;
            }
            #bscTraitCate input[type=button] {
                margin-left: 2px;
                font-size: 19px;
                color: #FFF;
                background-image: url('images/button.jpg');
            ...
            #bscTraitCate input[type=button]:hover {
                background-image: url('images/buttonh.jpg');
            }
            #bscTraits {
                margin-left: 20px;
...
<body>
	...
	<div id="container">
            <div id="header">
                <img style="width: 100%; height: 100%;" src="images/header2.jpg" />
            </div>
		<div id="navbar">
                    <ul>
